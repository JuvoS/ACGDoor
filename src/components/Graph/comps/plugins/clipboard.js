...
export default graph => {
    ...
    mxEvent.addListener(document, "keyup", function(evt) {
        ...
        //     if (evt.keyCode == 37) { console.log("keycode keyup -> 37"); }
        //     if (evt.keyCode == 38) { console.log("keycode keyup -> 38"); }
        //     if (evt.keyCode == 39) { console.log("keycode keyup -> 39"); }
        //     if (evt.keyCode == 40) { console.log("keycode keyup -> 40"); }

        // if (
        //     (!mxClient.IS_MAC && evt.keyCode == 17) /* Control */ &&
        //     (mxClient.IS_MAC && evt.keyCode == 90) /* Meta */
        // ) {
        //     console.log("ctrl + Z");
        // }
    });
