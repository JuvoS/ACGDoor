<template>
  <nav class="navtab">
    <ul>
      <li
        :class="{ 'navtab-item': true, active: navModel == 1 }"
        @click="onClickNav(1)"
      >
        <svg
          t="1580196202692"
      ...
      <li
        :class="{ 'navtab-item': true, active: navModel == 2 }"
        @click="onClickNav(2)"
      >
        <svg
          t="1580196351612"
      ...
      <li
        :class="{ 'navtab-item': true, active: navModel == 3 }"
        @click="onClickNav(3)"
      >
        <svg
          t="1580196428669"
      ...
      <li
        :class="{ 'navtab-item': true, active: navModel == 4 }"
        @click="onClickNav(4)"
      >
        <svg
          t="1580196480651"
...
.navtab {
  --navtab-width: 400px;
  --navtab-item-width: calc(var(--navtab-width) / 4 - 10px);
  --navtab-overlay-width: calc(var(--navtab-item-width));
  --active-index: 0;
  ...
  &::after {
    ...
    left: 0;
    width: 100%;
    height: var(--navtab-overlay-width);
    background: #b3e5fc;
    border-radius: 5px;
    transform: translateY(calc(var(--navtab-item-width) * var(--active-index)));
    transition: 0.5s ease;
  }
}
</style>
